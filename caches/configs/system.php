...
'cookie_pre' => 'UEYay_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.phpcms.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.phpcms.com/statics/js/', //CDN JS
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'd0gGmu5oeU0YWuBMCmWY', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.phpcms.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'ZhQGgtHBNEqPUQQgDa9P1zMWN5p0u5uI', //加密密钥
