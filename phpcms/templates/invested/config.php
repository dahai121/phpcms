<?php return array (
  ...
  'author' => '东方不败',
  'dirname' => 'invested',
  'homepage' => 'http://www.phpcms.com/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|invested|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|invested|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|invested|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|invested|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|invested|wap' => 
    array (
    ...
    'templates|invested|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|invested|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|invested|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|invested|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|invested|yp' => 
    array (
      'com_invested' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|invested|yp|com_invested' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|invested|comment' => 
    array (
